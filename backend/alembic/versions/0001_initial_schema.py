...
def upgrade():
    ...
    op.create_index("ix_ai_usage_tenant_id", "ai_usage_counters", ["tenant_id"])


def downgrade():
    for table in [
        "ai_usage_counters", "notifications", "activity_logs",
        "task_attachments", "task_comments", "tasks", "projects",
        "invite_tokens", "team_members", "teams", "tenant_members",
        "users", "tenants",
    ]:
        op.drop_table(table)
