...
//   const needsTeam = teamsLoaded && teams!.length === 0
...
//     mutationFn: () => workspaceApi.createTeam('My Team'),
...
//       await authApi.updateAvatarUrl(public_url)
//       refreshUser()
...
//                 </p>
//                 <button
//                   onClick={() => createTeam.mutate()} disabled={createTeam.isPending}
//                   className="rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 disabled:opacity-50"
//                 >
//                   {createTeam.isPending ? 'Creating...' : 'Create default team'}
//                 </button>
//               </div>
//             ) : !inviteTeamId ? (
